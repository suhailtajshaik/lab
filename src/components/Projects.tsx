    ...
    <section id="projects" style={{ padding: '6rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ marginBottom: '3rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.75rem' }}>
          <h2 style={{ fontSize: '1.75rem', fontWeight: 600, color: '#e5e7eb', display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}><span style={{ color: '#c9a962', fontWeight: 400 }}>03.</span> Active Projects<span style={{ height: '1px', background: '#1e293b', flex: 1, maxWidth: '300px' }} /></h2>
